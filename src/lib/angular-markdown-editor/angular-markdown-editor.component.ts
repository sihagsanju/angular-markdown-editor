...
export class AngularMarkdownEditorComponent implements AfterViewInit {
  ...
  hookToEditorEvents(options) {
    console.log('*******this is the conole inside the hookToEditorEvents events******');
  ...
  writeValue(value: string): void {
    this.value = value;
    console.log('*******this is the conole inside the writeValue events******');
  ...
  registerOnChange(fn: Function): void {
    console.log('*******this is the conole inside the registerOnChange events******');
    this.onModelChange = fn;
  }

  registerOnTouched(fn: Function): void {
    console.log('*******this is the conole inside the registerOnTouched events******');
